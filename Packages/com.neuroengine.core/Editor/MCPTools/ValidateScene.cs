...
namespace NeuroEngine.Editor.MCPTools
{
    ...
    public static class ValidateScene
    {
        public static object HandleCommand(JObject @params)
        {
            ...
            var validationEngine = EditorServiceLocator.Get<IValidationRules>();
            ...
            try
            {
                ...
                {
                    validationEngine.LoadRulesFromYaml(rulesPath);
                }
                ...
                if (!string.IsNullOrEmpty(specificRule))
                {
                    ...
                    var rules = validationEngine.GetRegisteredRules();
                    ...
                    report = validationEngine.ValidateScene();
                }
                else
                {
                    // Run all rules
                ...
                return new SuccessResponse(report.Summary, new
                {
                    ...
                    available_rules = validationEngine.GetRegisteredRules().Select(r => new
                    {
                        id = r.Id,
